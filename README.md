...
## Sample Code Pertemuan 6
Pertemuan 6 di OSG2 Android Basic membahas tentang SQLite, Room, @Dao, @Insert, @Update, @Delete dan @Query. Sample code ini berisi:
- Menambahkan Data Team
- Menampilkan List Team yang Sudah Dibuat
- Detail Team
- Update dan Delete Team
